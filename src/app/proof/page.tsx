  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
      ...
      <div className="mt-10 grid gap-5 lg:grid-cols-2">
        <Card><CardHeader><Fingerprint className="text-[var(--pass)]" aria-hidden="true" /><CardTitle className="mt-4">DecisionReceipt.v1</CardTitle><CardDescription>Stable, machine-readable proof bound to fixture, requirement, detector version, decision, health, issue codes, data class, and zero external calls.</CardDescription></CardHeader><CardContent><pre className="overflow-x-auto rounded-xl bg-[var(--surface-strong)] p-5 text-xs leading-6 text-white"><code>{`{
  "fixtureId": "CV-R4-BAD",
  "decision": "REJECT",
