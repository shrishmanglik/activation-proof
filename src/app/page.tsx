    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-10 sm:px-6 lg:px-8">
        <div className="grid gap-5 md:grid-cols-2">
          <Card className="border-[var(--pass-border)] bg-[var(--pass-bg)]"><CardHeader><CheckCircle2 aria-hidden="true" className="text-[var(--pass)]" /><CardTitle className="mt-3">Implemented now</CardTitle></CardHeader><CardContent><ul className="space-y-3 text-sm leading-6"><li>Bounded, authorable synthetic journey contract</li><li>12 typed fail-closed detector modules</li><li>24 contract-compiled synthetic controls</li><li>Input- and trace-bound SHA-256 receipts</li><li>Deny-all measured outbound capability</li><li>Exportable handoff with deterministic replay</li><li>Optional Supabase schema with tenant-consistent RLS, not connected</li></ul></CardContent></Card>
